...
- `05 | Models and Scenarios`: OLS regression, generalized linear regression, spatial autoregression, exploratory regression, geographically weighted modeling, and sensitivity tools for testing explanatory variables, spatial dependence, and scenario robustness.
