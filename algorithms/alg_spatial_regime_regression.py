...
class SpatialRegimeRegressionAlgorithm(HelpUrlMixin, QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        self._write_html(html_path, dep_var, indep_fields, regime_field, regime_labels, regime_counts, betas, coefficient_names, r2, chow_stat, chow_pvalue, skipped)
    ...
    def _write_html(self, path, dep_var, indep_fields, regime_field, regime_labels, regime_counts, betas, coefficient_names, r2, chow_stat, chow_pvalue, skipped):
        coef_rows = "".join(
