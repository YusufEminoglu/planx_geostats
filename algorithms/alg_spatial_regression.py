...
class SpatialRegressionAlgorithm(HelpUrlMixin, QgsProcessingAlgorithm):
    INPUT = "INPUT"
    DEP_VAR = "DEP_VAR"
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        self.write_html_report(results, html_path, dep_var, model_quality)
    ...
    def write_html_report(self, res: dict, path: str, dep_var: str, model_quality: dict):
