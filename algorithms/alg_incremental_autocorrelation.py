...
class IncrementalAutocorrelationAlgorithm(QgsProcessingAlgorithm):
    ...
    def _write_html(self, path, field, n, results, peak):
        ...
        rows = ""
        for r in results:
            is_peak = "★" if r["distance"] == peak["distance"] else ""
...
<head>
<meta charset="utf-8">
<title>PlanX-GeoStats Incremental Autocorrelation</title>
<style>
...
<div class="container">
    ...
    <footer>Generated by PlanX-GeoStats spatial statistics engine. ★ = Peak | ✓ = Significant (p &lt; 0.05)</footer>
</div>
</body>
</html>"""
